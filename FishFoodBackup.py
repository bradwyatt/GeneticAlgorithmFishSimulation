...
class RedFish(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.speed = 2
        self.image = pygame.transform.smoothscale(self.image, (random.randint(10, 20), random.randint(10, 20)))
    ...
    def drawCircleArc(self,screen,center,radius,startDeg,endDeg):
        ...
        for shark in sharks:
            if (arcPos.colliderect(shark) or linePos.colliderect(shark)):
                self.change_dir_timer = 0
                print str(shark.direction) + " shark dir"
                print str(shark.direction-math.pi/2) + " fish dir"
